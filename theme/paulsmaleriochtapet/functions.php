<?php
/**
 * Pauls Måleri & Tapet theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Pauls Måleri & Tapet Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through pa_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'paulsmaleriochtapet', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'paulsmaleriochtapet' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'paulsmaleriochtapet' ) ) );

		register_block_pattern_category( 'paulsmaleriochtapet-sections', array( 'label' => __( 'Pauls Måleri & Tapet sections', 'paulsmaleriochtapet' ) ) );
		register_block_pattern_category( 'paulsmaleriochtapet-pages', array( 'label' => __( 'Pauls Måleri & Tapet page layouts', 'paulsmaleriochtapet' ) ) );
	}
);
