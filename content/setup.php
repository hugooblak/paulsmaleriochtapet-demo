<?php
/**
 * Demo site setup for Pauls Måleri & Tapet.
 *
 ...
 * Site settings
 * ----------------------------------------------------------------------- */
update_option( 'blogname', 'Pauls Måleri & Tapet' );
...
$home = nps_page(
	...
	nps_pattern( 'paulsmaleriochtapet/page-home' ),
...
nps_page(
	'takomlaggning',
	'Takomläggning',
	nps_pattern( 'paulsmaleriochtapet/page-replacement' ),
...
nps_page(
	...
	nps_pattern( 'paulsmaleriochtapet/page-storm' ),
...
$quote = nps_page(
	'offert',
	'Boka besiktning',
	nps_pattern( 'paulsmaleriochtapet/quote-funnel' ),
...
$thanks = nps_page(
	'tack',
	'Tack',
	nps_pattern( 'paulsmaleriochtapet/thank-you' ),
...
<p class="has-large-font-size">Pauls Måleri & Tapet är ett familjeföretag från Sollentuna. Vi startade 1996 med en bil och en regel vi fortfarande håller oss till: priset vi skriver ner är priset du betalar.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:list -->
HTML;
nps_page( 'om-oss', 'Om Pauls Måleri & Tapet', $about_content . "\n\n" . nps_pattern( 'paulsmaleriochtapet/cta-inline' ), 'Familjeägt takföretag i norra Stockholm sedan 1996. Egna montörer, fasta priser skriftligt och 10 års garanti.' );
...
nps_page( 'vanliga-fragor', 'Vanliga frågor', $faq_content . "\n\n" . nps_pattern( 'paulsmaleriochtapet/cta-inline' ), 'Svar om offert, pris, ROT-avdrag, hur lång tid en takomläggning tar och vad garantin täcker.' );
...
<!-- /wp:paragraph -->
HTML;
$privacy = nps_page( 'integritetspolicy', 'Integritetspolicy', $privacy_content, 'Så använder Pauls Måleri & Tapet uppgifterna du skickar med offertformuläret.' );
...
nps_log( 'Pauls Måleri & Tapet demo ready.' );
